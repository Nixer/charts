...
from utils.last_sunday import last_sunday, human_date
from utils.charts_graphs import words_graph
...
def create_app():
    ...
    def index():
        if request.method == 'POST':
            ...
            graphs = words_graph(current_top_us, current_top_uk)
            return render_template('index.html', days=days, years=years, date=human_date(sunday),
            ...
            graphs = words_graph(current_top_us, current_top_uk)
            return render_template('index.html', days=days, years=years, date=human_date(latest_date_uk),
                                   current_top_us=current_top_us, current_top_uk=current_top_uk,
                                   graphs=graphs)
